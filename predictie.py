...
print(" INIȚIALIZARE RADAR MANUAL...\n")

evalueaza_o_regiune(
    nume_regiune="Odesa oblast", 
    arma="Shahed-136/131", 
    loc_lansare="Primorsko-Akhtarsk", 
    ora=2, 
    noapte=1, 
    sezon=1, 
    vreme=0
...
evalueaza_o_regiune(
    nume_regiune="Zaporizhzhia oblast", 
    arma="Iskander-M/KN-23", 
    loc_lansare="Kursk oblast", 
    ora=16,
    noapte=0, 
    sezon=0, 
    vreme=1
